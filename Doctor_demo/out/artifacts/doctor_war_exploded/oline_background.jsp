        ...
        function toChat() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    //发送成功
                    // alert("success");//data为后端post函数传递来的数据，这里写结果操作代码
                    <%--str = '<div class="lite-chatbox"><div class="cleft cmsg"><img class="headIcon radius" ondragstart="return false;" oncontextmenu="return false;" src="./img/A.jpg" /><span class="name">医生</span><span class="content">' + ${info};--%>
                    <%--str += '</span></div></div>';--%>
                    <%--//alert(data);--%>
                    <%--Words.innerHTML = Words.innerHTML + str;--%>
                }, error: function (data) {
                    ...
                    <div class="talk_show" id="words">
                        <div class="lite-chatbox">
                            <div class="tips"><span class="tips"
                                                    id="talksub">尊敬的客户,你好！为了向你提供优质快捷方便的服务，欢迎随时咨询相关牙齿问题</span></div>
                        </div>
                        <div class="lite-chatbox">
