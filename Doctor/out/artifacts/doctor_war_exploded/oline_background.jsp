    ...
    <script>
        function toListen(){
            $.ajax({
                ...
                type: "post",
                url: "receiveMessageServlet",//servlet文件名为Calculator，需要提前在web.xml里面注册，也可以在servlet界面通过@webServlet注册
                //dateType:"text",//数据类型，可以为json，xml等等，自己百度
                data: {"sendMessage": TalkWords.value},//操作数
                success: function (data) {
                    //发送成功
                    // alert("success");//data为后端post函数传递来的数据，这里写结果操作代码
                    str = '<div class="lite-chatbox"><div class="cleft cmsg"><img class="headIcon radius" ondragstart="return false;" oncontextmenu="return false;" src="./img/B.jpg" /><span class="name">客户</span><span class="content">' + data;
                    str += '</span></div></div>';
                    //alert(data);
        ...
        function toChat() {
            ...
            str = '<div class="lite-chatbox"><div class="cright cmsg"><img class="headIcon radius" ondragstart="return false;" oncontextmenu="return false;" src="./img/A.jpg" /><span class="name">您</span><span class="content">' + TalkWords.value;
            str += '</span></div></div>';

            $.ajax({
                //直接"post"或者"get",不需要"doPost","doGet"，该函数到后端接收缓冲区会自动匹配
                type: "post",
                url: "sendMessageServlet",//servlet文件名为Calculator，需要提前在web.xml里面注册，也可以在servlet界面通过@webServlet注册
                //dateType:"text",//数据类型，可以为json，xml等等，自己百度
                data: {"sendMessage": TalkWords.value},//操作数
                success: function (data) {
                    //发送成功
...
<!-- /header -->
<input type="button" value="开始聊天" onclick="toListen()">
<!-- main -->
                ...
                <div class="talk_con">
                    <div class="talk_show" id="words">
                        <div class="lite-chatbox">
                            <div class="tips"><span class="tips"
                                                    id="talksub">今天也要努力工作哦！</span></div>
                        </div>
