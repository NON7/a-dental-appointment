        ...
        <div id="login"><!-- 登录注册切换动画 -->
            ...
            <span>
                    <form action="post">
                        ...
                        <p class="form confirm"><input type="text" id="identity_card" placeholder="identity_card"></p>
                        <input type="button" value="Log in" class="btn" onclick="login()" style="margin-right: 20px;">
                        <input type="button" value="Sign in" class="btn" onclick='signin()' id="btn"></p>
...
<script>
    ...
    function signin() {
        ...
        if (onoff) {
            ...
            window.location.href ="RegistServlet?username="+user.value+"&pwd="+passwd.value+"&identity_card="+identity_card.value;
                ...
                if (this.readyState == 4) {
                    if (this.responseText == false)
                        hint()
                         ...
                         window.location.href ="LoginServlet?username="+user.value+"&pwd="+passwd.value;
                }
            }
            request.send(data)
        } else {
